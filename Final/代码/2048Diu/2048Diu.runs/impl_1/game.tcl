...
set rc [catch {
  ...
  add_files -quiet E:/NL/projects/2048Diu/2048Diu.runs/synth_1/game.dcp
...
set rc [catch {
  ...
  read_checkpoint  -incremental E:/NL/projects/2048Diu/2048Diu.srcs/utils_1/imports/impl_1/game_routed.dcp
  catch { report_incremental_reuse -file game_incremental_reuse_pre_placed.rpt }
